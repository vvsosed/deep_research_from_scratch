...
# Initialize models
compress_model = init_chat_model(model=os.getenv("COMPRESS_MODEL", "openai:gpt-4.1"), max_tokens=32000)
model = init_chat_model(model=os.getenv("RESEARCH_AGENT_MODEL", "anthropic:claude-sonnet-4-20250514"))
